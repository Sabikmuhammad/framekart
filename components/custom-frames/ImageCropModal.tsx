...
import { X, ZoomIn, Check, Info } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { Slider } from "@/components/ui/slider";
import { createCroppedImage } from "@/lib/utils/image-utils";
import { CropData } from "@/lib/types/custom-frame";
        ...
        >
          <Card className="border-0 shadow-2xl">
            <CardContent className="p-0">
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Adjust the crop area to fit your frame
                  </p>
                </div>
                <Button
                  variant="ghost"
              ...
              {/* Info Banner */}
              <div className="bg-primary/5 dark:bg-primary/10 border-b border-primary/20 p-4">
                <div className="flex items-start gap-3">
                  <Info className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <div className="text-sm text-primary">
                    <p className="font-semibold mb-1">Cropping is optional</p>
                    <p>
                      If you don&apos;t crop, our design team will adjust spacing to fit your full image.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Controls */}
              <div className="p-6 bg-white dark:bg-gray-900 space-y-4 border-t border-gray-200 dark:border-gray-800">
                {/* Zoom Control */}
