          ...
          <Card className="bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-950/20 dark:to-purple-950/20 border-pink-200 dark:border-pink-800">
            <CardContent className="py-6 text-center">
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-bold text-pink-900 dark:text-pink-100">Follow Us on Instagram!</h3>
              </div>
              <p className="text-sm text-pink-800 dark:text-pink-200 mb-4">
                Stay updated with our latest designs, exclusive offers, and customer stories
              </p>
              <a
                href="https://www.instagram.com/framekartofficial/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-semibold rounded-full transition-all transform hover:scale-105 shadow-lg"
              >
