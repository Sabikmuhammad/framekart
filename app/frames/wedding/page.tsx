...
import { Upload, Loader2, ShoppingCart, Info, Heart, ArrowLeft, AlertCircle } from "lucide-react";
...
export default function WeddingFramePage() {
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!isSignedIn) {
      ...
      router.push("/sign-in?redirect=/frames/wedding");
      return;
    }
  ...
  const handleAddToCart = () => {
    ...
    try {
      const templateItem = {
        _id: `template-wedding-${Date.now()}`,
        title: `Wedding Frame - A4 ${frameStyle}`,
        price: FIXED_PRICE,
        imageUrl: WEDDING_TEMPLATE,
        frame_size: "A4",
        frame_material: frameStyle,
        isTemplate: true,
        templateFrame: {
          occasion: "wedding" as const,
          templateImage: WEDDING_TEMPLATE,
      ...
      toast({
        title: "Added to cart!",
        description: "Your wedding frame has been added to the cart.",
      });
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-800">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold">Upload Couple Photo</h3>
